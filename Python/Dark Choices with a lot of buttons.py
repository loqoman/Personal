...
pygame.draw.rect(windowSurface,BACKGROUNDC,background_rect,0)
...
# handler for pick up button, called at mouse click
    ...
    change_button('Option1','collect',pickup_option_handler)
...
# main game initialization routine to set up screen and some game variables
    ...
    #they are left blank for now
     ...
     opt3 = Button(name='Option3',color=BLACK,
                  ...
                  size = 12, label = '               ',
                  group = 'Option')  
     opt4 = Button(name='Option1',color=BLACK,
                  topleft = (700,25),
                  size = 12, label = '              ',
                  group = 'Option')

     opt5 = Button(name='Option2',color=BLACK,
                  topleft = (opt1.left,opt1.bottom+5),
                  size = 12, label = '              ',
                  group = 'Option')    

     opt6 = Button(name='Option3',color=BLACK,
                  topleft = (opt2.left,opt2.bottom+5),
                  size = 12, label = '               ',
                  group = 'Option')
     opt7 = Button(name='Option2',color=BLACK,
                  topleft = (opt1.left,opt1.bottom+5),
                  size = 12, label = '              ',
                  group = 'Option')    

     opt8 = Button(name='Option3',color=BLACK,
                  topleft = (opt2.left,opt2.bottom+5),
                  size = 12, label = '               ',
                  group = 'Option')  
...
scroll = Scroll(num_lines=10,topleft=(0,20),text = '',
